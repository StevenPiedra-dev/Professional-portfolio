      ...
      <div class="modal-card" (click)="$event.stopPropagation()">
        ...
        <div class="modal-body">
          ...
          <div class="meta-chips-row">
            <button class="star-chip-btn" [class.starred]="isStarred()" (click)="onStarClick($event)" [title]="isStarred() ? 'Remove star' : 'Star project'">
              {{ isStarred() ? '⭐' : '☆' }} {{ getStars() }} {{ isStarred() ? 'Starred' : 'Star Project' }}
            </button>
          ...
          <div class="description-section">
            <h4 class="section-subtitle">Project Overview</h4>
        ...
        <div class="modal-footer">
          ...
          <button class="action-btn close-footer-btn" (click)="closeModal()">Close</button>
        </div>
      </div>
    </div>
  `,
